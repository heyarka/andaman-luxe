              ...
              <div className="p-4 md:p-6">
                ...
                <button
                  ...
                  className={`w-full rounded-lg py-2 md:py-3 text-[10px] md:text-sm font-semibold transition-all mb-2 md:mb-3 ${
                    pkg.recommended
                      ? "bg-gradient-to-r from-amber-500 to-amber-400 text-slate-950 hover:brightness-105 shadow-[0_10px_24px_-14px_rgba(245,158,11,0.8)]"
                      : "bg-amber-100/80 text-amber-700 hover:bg-amber-200/90"
                  }`}
                >
                  Book This Package
                </button>
