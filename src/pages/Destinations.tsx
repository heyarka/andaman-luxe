...
import { destinationDetailsData } from "@/data/destinationDetails";
import rossSmithImg from "@/assets/ross-smith.jpg";
import cellularJailImg from "@/assets/cellular-jail.jpg";
import havelockImg from "@/assets/destinations.jpg";
import neilImg from "@/assets/destinations.jpg";
import baratangImg from "@/assets/water-sports.jpg";
import northBayImg from "@/assets/ferry-services.jpg";
import chidiyaTapuImg from "@/assets/destinations.jpg";
import mountHarriettImg from "@/assets/hero-beach.jpg";
import diglipur from "@/assets/destinations.jpg";
import rangatImg from "@/assets/destinations.jpg";
import longIslandImg from "@/assets/water-sports.jpg";
...
const destinations = [
  ...
  },
  {
    ...
    description: "Premium island destination with white sand beaches, water sports, and luxury resorts",
    tags: ["Radhanagar Beach", "Scuba Diving", "Luxury Resorts"],
  },
  {
    image: neilImg,
    badge: "Offbeat Gem",
    ...
    title: "Neil Island",
    description: "Serene island escape with peaceful beaches, village tours, and authentic island life",
    tags: ["Lagginiya Beach", "Village Tourism", "Coral Gardens"],
  },
  {
    image: baratangImg,
    badge: "Natural Attraction",
    location: "Middle Andaman",
    title: "Baratang Island",
    description: "Unique island famous for limestone caves, mangrove forests, and underground lakes",
    tags: ["Limestone Caves", "Mangrove Kayaking", "Mud Volcanoes"],
  },
  {
    image: northBayImg,
    badge: "Adventure Stop",
    location: "Port Blair",
    title: "North Bay Island",
    description: "Popular day-trip destination with glass-bottom boats and vibrant coral reefs",
    tags: ["Glass Bottom Boat", "Coral Reef", "Marine Life"],
  },
  {
    image: chidiyaTapuImg,
    badge: "Nature Retreat",
    location: "South Andaman",
    title: "Chidiya Tapu",
    description: "Scenic hilltop location offering panoramic sunset views and birdwatching opportunities",
    tags: ["Sunset Views", "Bird Sanctuary", "Scenic Views"],
  },
  {
    image: mountHarriettImg,
    badge: "Historical Park",
    location: "South Andaman",
    title: "Mount Harriet National Park",
    description: "Pristine national park with hiking trails, panoramic vistas, and rich biodiversity",
    tags: ["Trekking Trails", "Panoramic Views", "Wildlife Sanctuary"],
  },
  {
    image: diglipur,
    ...
    location: "North Andaman",
    title: "Diglipur",
    description: "Tranquil northern destination with pristine beaches and adventure activities",
    tags: ["Pristine Beaches", "Island Hopping", "Natural Springs"],
  },
  {
    image: rangatImg,
    badge: "Scenic Retreat",
    location: "North Andaman",
    title: "Rangat",
    description: "Peaceful destination surrounded by emerald forests and idyllic island scenery",
    tags: ["Forest Trails", "Beach Escape", "Local Culture"],
  },
  {
    image: longIslandImg,
    badge: "Untouched Beauty",
    location: "North-Middle Andaman",
    title: "Long Island",
    description: "Remote island sanctuary with pristine beaches and abundant marine and wildlife",
    tags: ["Beach Trekking", "Marine Sanctuary", "Wildlife"],
  },
];
...
const Destinations = () => {
  ...
  const getDestinationDetails = (title: string) => {
    return (destinationDetailsData as Record<string, any>)[title] || null;
  };
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          {destinations.map((dest, i) => (
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <button
                  onClick={() => handleLearnMore(dest.title)}
                  className="mt-auto inline-flex items-center gap-2 text-sm font-semibold text-primary hover:text-accent transition-colors"
                >
      ...
      <DestinationModal
        destination={selectedDestination ? getDestinationDetails(selectedDestination) : null}
